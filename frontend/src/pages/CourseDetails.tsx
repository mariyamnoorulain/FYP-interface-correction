...
export default function CourseDetails({ course, onBack }: Props) {
  ...
  const teacherProfile = {
    ...
    rating: 4.8,
    students: 1250,
    bio: 'Passionate educator with 10+ years of experience in teaching computer science and AI. Dedicated to helping students understand complex concepts through practical examples.'
  };
